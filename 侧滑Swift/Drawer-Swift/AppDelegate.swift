...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func createWindow() {
        ...
        let tab = CHKTabBarController()
        tab.addItems(arr[0], imgNames: arr[1], hightNames: arr[2], classNames: arr[3])
        window?.rootViewController = CHKMainViewController().create(CHKMyViewController(), tabVC: tab)
